...
- **Microsoft** [GraphRAG: unlocking LLM discovery on narrative private data](https://www.microsoft.com/en-us/research/blog/graphrag-unlocking-llm-discovery-on-narrative-private-data/) (2024): builds a knowledge graph and a community hierarchy from the corpus, then answers global, whole-corpus questions ("summarize the themes") that plain top-k chunk retrieval cannot, by summarizing communities rather than isolated chunks. Reach for it when queries are global rather than local lookups. *(product design)*
